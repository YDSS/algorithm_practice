...
function getArticulationPoints(adList, start) {
    let visited = {}; // record visited vertexes
    let parent = {}; // record vertex's parent 
    let nums = {}; // record number of every vertex, number is ordered by pre-ordered traverse
    let lows = {}; // record low of every vertex
...
let adList = new AdjacencyList_1.default(vertexes, edges);
adList.print();
let arts = getArticulationPoints(adList, 'A');
console.log(arts);
//# sourceMappingURL=getArticulationPoints.js.map